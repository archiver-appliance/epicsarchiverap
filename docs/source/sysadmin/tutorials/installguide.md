...
[System requirements](../references/system-requirements), the
...
2. Optionally, create your `policies.py` file (see [Policies](../guides/create-policy-file))

In addition to installing the JDK and EPICS (see [System requirements](../references/system-requirements)), for each appliance:

1. [Install and configure Tomcat](../guides/tomcat-setup)
2. [Install MySQL](../guides/mysql-setup)
3. Set up storage folders (see [Policies](../guides/create-policy-file#setting-up-storage-folders))
