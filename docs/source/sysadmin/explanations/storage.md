...
[Apache Parquet](../../sysadmin/references/parquet) and stores data in chunks. Each chunk has a
...
key/value store).
    ...
    convention. To use your own mapping scheme, see the [Key Mapping](../guides/customization) section in the
    customization guide.
    :::
