# Retrieving data using the HTTP API
...
4. RAW - This is a binary format used by the Archive Viewer and is
   based on the [PB/HTTP](../references/pb_pbraw) protocol.
...
respective how-to guides: [CS-Studio](../../reader/guides/cstudio),
[Archive Viewer](../../reader/guides/archiveviewer), [Matlab](../../reader/guides/matlab).
