...
For a more automated approach, the `/changeStore` [Management BPL action](../../developer/references/mgmt_scriptables.md) can be used to update the storage configuration for a single PV. This action allows you to:
