...
# This script does some basic validation on one or more PB files and tries to repair them if it detects any errors.
...
java -Xmx2G -cp "${CLASSPATH}" edu.stanford.slac.archiverappliance.PlainPB.utils.ValidateAndFixPBFile $@
