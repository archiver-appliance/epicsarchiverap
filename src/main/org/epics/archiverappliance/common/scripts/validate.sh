...
# This script does some basic validation on one or more PB files.
...
java -Xmx2G -cp "${CLASSPATH}" edu.stanford.slac.archiverappliance.plain.utils.ValidatePlainFile $@
