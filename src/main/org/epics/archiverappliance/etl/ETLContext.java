...
public class ETLContext extends BasicContext {
    ...
    private boolean skipBulkAppend = false;

    public ETLContext() {
        this(false);
    }

    public ETLContext(boolean skipBulkAppend) {
        this.skipBulkAppend = skipBulkAppend;
    }
    ...
    /**
     * @return Do not use bulk append for optimization ( if the plugin supports this )
     */
    public boolean isSkipBulkAppend() {
        return skipBulkAppend;
    }
}
