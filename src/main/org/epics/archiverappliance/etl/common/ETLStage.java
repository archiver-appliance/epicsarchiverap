...
public class ETLStage {
    ...
    private final ETLMetricsIntoStore metricsForLifetime;
    ...
    private final OutOfSpaceHandling outOfSpaceHandling;
    ...
    public long getInitialDelay() {
        ...
        return Duration.between(currentTime, this.nextETLStart).getSeconds();
    }
}
