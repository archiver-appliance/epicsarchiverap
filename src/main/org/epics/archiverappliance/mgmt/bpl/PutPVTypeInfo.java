 ...
 * @epics.BPLActionParam override - If the PVTypeInfo for this PV already exists, do you want to update it or return an error? By default, this is false; this may change later.
 * @epics.BPLActionEnd
 * @author mshankar
 *
 */
