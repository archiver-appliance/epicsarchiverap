...
public class GetETLReadyFiles {
	...
	public static void main(String[] args) throws Exception {
		...
		Path[] paths = PathNameUtility.getPathsBeforeCurrentPartition(new ArchPaths(), folder.getAbsolutePath(), pvName, now, pbFileExtension, granularity, PBCompressionMode.NONE, configService.getPVNameToKeyConverter());
