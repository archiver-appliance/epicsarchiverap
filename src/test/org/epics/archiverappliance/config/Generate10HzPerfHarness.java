...
/**
 * Generates a 10Hz performance SIOC database and JDBM2 persistence file in the current folder.
 * This generates 4000 DBR_DOUBLE PV's changing at 10Hz.
 ...
 *
 */
public class Generate10HzPerfHarness {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Generating 10Hz perf harness for appliance " + instanceName);
        ...
        try (PrintWriter out = new PrintWriter(new FileOutputStream(siocDB))) {
            ...
            for (int i = startingAt; i < (startingAt + pvcount); i++) {
                ...
                jsonStr.append(
                        "{\"upperDisplayLimit\":\"0.0\",\"computedBytesPerEvent\":\"19\",\"userSpecifiedEventRate\":\"0.0\",\"lowerCtrlLimit\":\"0.0\",\"lowerDisplayLimit\":\"0.0\",\"samplingPeriod\":\"0.01\",\"lowerAlarmLimit\":\"NaN\",\"computedEventRate\":\"1.0166667\",\"extraFields\":{\"NAME\":\""
                                + pvName
                                + "\",\"RTYP\":\"ai\",\"ADEL\":\"0.0\",\"MDEL\":\"0.0\",\"SCAN\":\"0.0\"},\"creationTime\":\"2012-08-23T23:29:06.841Z\",\"DBRType\":\"DBR_SCALAR_DOUBLE\",\"hasReducedDataSet\":\"false\",\"upperWarningLimit\":\"NaN\",\"computedStorageRate\":\"19.383333\",\"applianceIdentity\":\""
                                + instanceName
                                + "\",\"precision\":\"0.0\",\"scalar\":\"true\",\"samplingMethod\":\"MONITOR\",\"paused\":\"false\",\"elementCount\":\"1\",\"pvName\":\""
                                + pvName
                                + "\",\"modificationTime\":\"2012-08-23T23:29:06.841Z\",\"upperAlarmLimit\":\"NaN\",\"upperCtrlLimit\":\"0.0\",\"units\":\"Lollipo\",\"dataStores\":[\"pb:\\/\\/localhost?name=STS&rootFolder=${ARCHAPPL_SHORT_TERM_FOLDER}&partitionGranularity=PARTITION_HOUR\",\"pb:\\/\\/localhost?name=MTS&rootFolder=${ARCHAPPL_MEDIUM_TERM_FOLDER}&partitionGranularity=PARTITION_DAY&hold=2&gather=1\",\"pb:\\/\\/localhost?name=LTS&rootFolder=${ARCHAPPL_LONG_TERM_FOLDER}&partitionGranularity=PARTITION_YEAR&pp=firstSample&pp=firstSample_3600\"],\"archiveFields\":[\"LOLO\",\"HIGH\",\"LOW\",\"LOPR\",\"HOPR\",\"HIHI\"],\"lowerWarningLimit\":\"NaN\"}");
