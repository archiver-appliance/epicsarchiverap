    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PrintWriter out = new PrintWriter(new FileOutputStream(siocDB))) {
            ...
            for (int i = startingAt; i < (startingAt + pvcount); i++) {
                ...
                jsonStr.append(
                        "{\"upperDisplayLimit\":\"0.0\",\"computedBytesPerEvent\":\"19\",\"userSpecifiedEventRate\":\"0.0\",\"lowerCtrlLimit\":\"0.0\",\"lowerDisplayLimit\":\"0.0\",\"samplingPeriod\":\"1.0\",\"lowerAlarmLimit\":\"NaN\",\"computedEventRate\":\"1.0166667\",\"extraFields\":{\"NAME\":\""
                                + pvName
                                + "\",\"RTYP\":\"ai\",\"ADEL\":\"0.0\",\"MDEL\":\"0.0\",\"SCAN\":\"10.0\"},\"creationTime\":\"2012-08-23T23:29:06.841Z\",\"DBRType\":\"DBR_SCALAR_DOUBLE\",\"hasReducedDataSet\":\"false\",\"upperWarningLimit\":\"NaN\",\"computedStorageRate\":\"19.383333\",\"applianceIdentity\":\""
                                + instanceName
